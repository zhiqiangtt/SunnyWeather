...
private val sky = mapOf(
    ...
    "CLEAR_NIGTH" to Sky("晴", R.drawable.ic_clear_night, R.drawable.bg_clear_night),
    ...
    "LIGTH_RAIN" to Sky("小雨", R.drawable.ic_light_rain, R.drawable.bg_rain),
    ...
    "SLEET" to Sky("雪夹雪", R.drawable.ic_sleet, R.drawable.bg_rain),
